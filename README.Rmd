...
```{r map_plot,fig.width=5.5, fig.height=7,echo=FALSE,warning=FALSE,message=FALSE}
...
```{r worldmap,fig.width=7, fig.height=5.5,echo=FALSE,warning=FALSE,message=FALSE}
options(kmlpath = "/Users/edmundhart/kmltemp")
